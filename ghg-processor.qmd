...
results_fields <- c(
  ...
  "statistic" = "Linear flux model statistic (SS)",
  ...
  "Gas" = "Gas (CO2 or CH4)",
  "Units" = "Flux units",
  "flux_estimate" = "Slope of linear flux model, units/s",
  "flux_std.error" = "Standard error of slope of linear flux model",
  "flux_statistic" = "Statistic of slope of linear flux model",
  "flux_p.value" = "P-value of slope of linear flux model",
  "flux_estimate_robust" = "Slope of robust flux model",
  "r.squared_poly" = "Polynomial flux model R2",
  "int_estimate" = "Intercept of linear flux model, units",
  "int_std.error" = "Standard error of intercept of linear flux model",
  "int_statistic" = "Statistic of intercept of linear flux model",
  ...
  "Area" = "Area entry from metadata file",
  "Chambers" = "Chambers entry from metadata file",
  "Volume" = "Volume entry from metadata file",
  "Light" = "Light entry from metadata file",
  "Site" = "Site entry from metadata file",
  "Zone" = "Zone entry from metadata file",
  "Rep" = "Rep entry from metadata file",
  "Temp" = "Temp entry from metadata file",
  "Dead_band" = "Dead band entry from metadata file",
  "Msmt_stop" = "Measurement stop entry from metadata file",
  "Notes" = "Notes entry from metadata file",
...
results_metadata <- data.frame(Field_name = names(results))
results_metadata$Description <- results_fields[results_metadata$Field_name]

metadata_fn <- mkfn("results_metadata", "csv")
message("Writing metadata ", metadata_fn, "...")
write_csv(results_metadata, metadata_fn)
```

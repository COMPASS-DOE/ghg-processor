...
results$F_ROBUST_DIV <- is_outlier(with(results, (flux_estimate - flux_estimate_robust) / flux_estimate))
ggplot(results, aes(x = flux_estimate, y = flux_estimate_robust, color = F_ROBUST_DIV)) + 
  geom_point() + 
